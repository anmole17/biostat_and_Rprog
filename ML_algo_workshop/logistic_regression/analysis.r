...
data = read.csv("./logistic_regression/fitted_data.csv" ,header=TRUE)
colnames(data)

## call "plot.roc()" function to plot the curve

rocobj <- plot.roc(data$wine_quality, data$P,             # data vectors       
...
## Add the Confidence interval plot to the already existing plost
